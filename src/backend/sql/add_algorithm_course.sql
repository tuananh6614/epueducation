...
-- Insert the course (sử dụng các trường phù hợp với cấu trúc bảng courses của bạn)
INSERT INTO courses (
  title, 
  description, 
  price, 
  ...
  0.00,
  1, -- user_id thay vì instructor_id 
  @category_id,
  'intermediate',
  TRUE
);
...
-- Insert lessons for the course, đảm bảo các trường phù hợp với bảng lessons
