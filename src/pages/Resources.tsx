      ...
      <Dialog open={openDepositDialog} onOpenChange={setOpenDepositDialog}>
        <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
          ...
          <div className="mt-4">
            ...
            {depositTab === 'phone' && (
              <div className="mt-6 text-center">
                <h3 className="text-lg font-medium mb-4">Nạp thẻ điện thoại</h3>
      ...
      <Dialog open={openPurchaseDialog} onOpenChange={setOpenPurchaseDialog}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Xác nhận mua tài liệu với thông tin dưới đây.
            </DialogDescription>
          </DialogHeader>
          ...
          {selectedResource && (
            <div className="py-4">
              <div className="flex items-start gap-4 mb-4">
                <div className="bg-gray-100 rounded-md p-3 flex-shrink-0">
              ...
              {userBalance < (selectedResource.price || 0) && (
                <div className="mt-4 p-3 bg-red-50 text-red-700 rounded-md text-sm">
                  Số dư của bạn không đủ để mua tài liệu này. Vui lòng nạp thêm tiền.
                </div>
              )}
            </div>
          )}
